...
$query=mysqli_query($con,"SELECT * FROM user WHERE email='$email' and mobileno='$mobileno'");
$num=mysqli_fetch_array($query);
if($num>0)
{
$extra="forgot-password.php";
mysqli_query($con,"update user set password='$password' WHERE email='$email' and mobileno='$mobileno' ");
...
<html lang="en">
	<head>
	    ...
	    <title>Women Clothing | Forgot Password</title>
...
?>
		...
		<div class="form-group">
		 ...
		 <input type="text" name="mobileno" class="form-control unicase-form-control text-input" id="mobileno" required>
		</div>
<div class="form-group">
