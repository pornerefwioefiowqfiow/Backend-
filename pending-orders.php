...
header('location:login.php');
	...
	if (isset($_GET['id'])) 
	{
		...
		mysqli_query($con,"delete from orders where u_id='".$_SESSION['u_id']."'");
		;
...
<?php $query=mysqli_query($con,"select product.p_image1,product.p_name,product.p_id,orders.p_id,orders.o_quantity,product.p_price,orders.o_date,orders.o_id from orders join product on orders.p_id=product.p_id where orders.u_id ='".$_SESSION['u_id']."'");
$cnt=1;
...
?>
				<tr>
					...
					<td><a href="pending-orders.php?p_id=<?php echo $row['o_id']; ?> ">Delete</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
<tr>
